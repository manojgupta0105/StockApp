...
class App extends Component {
  ...
  handleData(data) {
    ...
    JSON.parse(data).forEach((stockItem) => {
      ...
      stockData[stockItem[0]].timeAgo = moment().diff(
        stockData[stockItem[0]].timeStamp,
        "seconds"
      );
    ...
    return (
      <div className="App">
        <header className="App-header">
                ...
                return (
                  <tr>
                    ...
                    <td
                      style={{
                        background: `${
                          stockData[item].status === 0
                            ? "transparent"
                            : stockData[item].status === -1
                            ? "red"
                            : "green"
                        }`,
                      }}
          ...
          <Websocket url={serverUrl} onMessage={this.handleData.bind(this)} />
        </header>
      </div>
    );
  }
